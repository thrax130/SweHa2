...
/**
 * This is the item provider adapter for a {@link emfKalender2.Month} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MonthItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Month_month_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Month_month_feature", "_UI_Month_type"),
				 EmfKalender2Package.Literals.MONTH__MONTH,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EmfKalender2Package.Literals.MONTH__DAYS);
		}
	...
	public String getText(Object object) {
		Month m = (Month)object;
		String label = "Monat ";
		if(m.getMonth() != null) {
			label += String.format("%02d", m.getMonth().getValue())+ " ["+m.getMonth().getLiteral()+"]";
		}
		return label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Month.class)) {
			case EmfKalender2Package.MONTH__MONTH:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case EmfKalender2Package.MONTH__DAYS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EmfKalender2Package.Literals.MONTH__DAYS,
				 EmfKalender2Factory.eINSTANCE.createDay()));
	}
